class TreemapChart {
    constructor(container, data, option) {
        ...
        this.width = option?.width ? option.width : d3.select(this.container)._groups[0][0].clientWidth > 0 ? d3.select(this.container)._groups[0][0].clientWidth : 1520
        this.height = option?.height ? option.height : d3.select(this.container)._groups[0][0].clientHeight > 0 ? d3.select(this.container)._groups[0][0].clientHeight : 380
        this.data = data
    ...
    render() {
                                      ...
                                      <div id="deviceRatio" style="display: flex; align-items: center; height: 50px; gap: 5px; padding-top: 20px">
                                          ...
                                          <div id="progressBar" style="opacity: 0;display: flex; align-items:center; height: 100%; flex: 1">
                                              <div id="pcRatio"  style="height:100%; border-top-left-radius: 3px; border-bottom-left-radius: 3px">
                                                  <h5 style="text-align:center; height: 100%; color: white; font-size: 12px"></h5>
                                                  </div>
        ...
        function render(group, root) {
          ...
          border-color: rgba(0,0,0,0.5) transparent transparent transparent;
                        ...
                        tooltip.style('left', `${xPos - tooltipWidth / 2}px`).style('top', `${y(d.y0) - 68}px`)
                        tooltip.transition().duration(1000).style('opacity', '1').style('top', `${y(d.y0) - 38}px`)
                    }
